...
public:
  ...
  int rescue_arm_duration = 1250; //the time before the motor reduces power
  void hold()
  {
...
void loop()
{
  chassis.halt();
  Serial.print("Raw: ");
  Serial.println(analogRead(distance_sensor1));
